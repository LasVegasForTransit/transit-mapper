/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7aeeb8911e930b4c6032b850243c116e)
// Runtime types generated with workerd@1.20260722.1 2025-07-01 
interface __BaseEnv_Env {
	GTFS_ARCHIVES: R2Bucket;
	DB: D1Database;
	SHARE_CREATE_LIMITER: RateLimit;
	VIEW_CREATE_LIMITER: RateLimit;
	PERFORMANCE_SAMPLE_LIMITER: RateLimit;
	PLACE_SEARCH_LIMITER: RateLimit;
	PLACE_UPSTREAM_LIMITER: RateLimit;
	OSM_TILE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	SITE_URL: "https://transitmapper-preview.invalid" | "https://map.lasvegasfortransit.org";
	NOMINATIM_URL: "https://nominatim.openstreetmap.org/search";
	PLACE_SEARCH_GATE: DurableObjectNamespace<import("./src/entry").PlaceSearchGate>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/entry");
		durableNamespaces: "PlaceSearchGate";
	}
