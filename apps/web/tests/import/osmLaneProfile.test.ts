...
describe("OSM import builds a lane-by-lane profile from a way's tags", () => {
  describe('bike lanes tagged on the roadway', () => {
  ...
  describe("placing lanes for the system's driving side", () => {
    ...
    // Each tag gets its own case, since each iteration asserts a distinct named fact.
    it.each([
      ['cycleway:left', 'lane'],
