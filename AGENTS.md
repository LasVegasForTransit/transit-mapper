...
| An agent-assisted commit carries a `Co-Authored-By` footer                      | no hook can tell whether an agent helped; 19 of 200 commits had one before this was written down                         | **nothing**                     |
