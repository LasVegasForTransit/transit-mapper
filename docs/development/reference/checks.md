...
| `check:github-metadata` | the issue or pull request templates, workflow status, or governance status name disagree with the canonical contribution contract | `make the template, trusted workflow, and governance standard consume the same metadata contract`         |
