// Core stamps these glyph values onto browser-free render features. The
// renderer re-exports the same values as part of its layer vocabulary so the
// feature producer and MapLibre icon registration cannot diverge.
